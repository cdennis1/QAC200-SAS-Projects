...
DATE: Thursday, January 08, 2015     TIME: 1:24:53 AM
PROJECT: Project2
PROJECT PATH: C:\Users\cdennis\Desktop\Assignments\Project2.egp
---------------------------------------- */
...
%LET _CLIENTPROJECTPATH='C:\Users\cdennis\Desktop\Assignments\Project2.egp';
%LET _CLIENTPROJECTNAME='Project2.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 08, 2015 at 1:20:55 AM
...
PROC SQL;
   ...
   SELECT t1.DUPERSID, 
          ...
          t1.OBTOTV12, 
          t1.ERTOT12
      FROM EC100019.meps_fullyr_2012 t1
      WHERE t1.AGE12X >= 18
...
/* -------------------------------------------------------------------
   ...
   Input Data: Local:WORK.FILTER_FOR_MEPS_FULLYR_2012_SAS7
   Server:  Local
   ------------------------------------------------------------------- */
...
PROC DATASETS NOLIST NODETAILS; 
   CONTENTS DATA=WORK.FILTER_FOR_MEPS_FULLYR_2012_SAS7 OUT=WORK.SUCOUT1;

RUN;

DATA WORK.CONTContentsForFILTER_FOR_MEPS_F(LABEL="Contents Details for FILTER_FOR_MEPS_FULLYR_2012_SAS7");
   SET WORK.SUCOUT1;
RUN;
...
CREATE TABLE WORK.SCTABLE AS
	SELECT * FROM WORK.SCVIEW
		WHERE memname='FILTER_FOR_MEPS_FULLYR_2012_SAS7';
QUIT;
